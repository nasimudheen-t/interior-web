...
const Gallery = () => {
  const images = [
    { src: '/src/assets/images/hero_interior.png', alt: 'Living Room', height: 'h-[400px]' },
    { src: '/src/assets/images/gallery_kitchen.png', alt: 'Kitchen', height: 'h-[600px]' },
    { src: '/src/assets/images/gallery_bedroom.png', alt: 'Bedroom', height: 'h-[500px]' },
    { src: '/src/assets/images/gallery_bathroom.png', alt: 'Bathroom', height: 'h-[450px]' },
    { src: '/src/assets/images/hero_interior.png', alt: 'Detail Shot', height: 'h-[550px]' },
    { src: '/src/assets/images/gallery_kitchen.png', alt: 'Dining Area', height: 'h-[350px]' },
  ];
